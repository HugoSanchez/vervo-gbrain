...
If the local embedding model is not installed, embeddings can't be generated.
Keyword search still works without embeddings, but hybrid/semantic search won't.
